...
#define PFNEGLUPDATEWAYLANDBUFFERWL PFNEGLUPDATEWAYLANDBUFFERWLPROC
struct wl_display;
struct wl_resource;
...
typedef EGLBoolean (EGLAPIENTRYP PFNEGLUPDATEWAYLANDBUFFERWLPROC) (EGLDisplay dpy, struct wl_resource *buffer, EGLint attribute);
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglUpdateWaylandBufferWL (EGLDisplay dpy, struct wl_resource *buffer, EGLint attribute);
